...
title: "Variational Calculus for Optimization"
slug: variational-calculus
description: "A crash course on the calculus of functionals, exploring how to optimize entire functions. Covers the Euler-Lagrange equation, connections to physics (Lagrangian/Hamiltonian), the Legendre transform, and applications to classic optimization problems."
level: Intermediate
cover: # To be filled if a specific cover image is decided
categories:
- Crash Course
- Calculus
tags:
