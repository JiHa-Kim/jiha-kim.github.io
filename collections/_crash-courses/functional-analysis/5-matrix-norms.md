...
<details class="details-block" markdown="1">
<summary markdown="1">
**Example.** $$\ell_p$$ norms on $$\mathbb{R}^n$$
</summary>
...
Similar to vector norms on $$\mathbb{R}^n$$, matrix norms measure the "size" of matrices.
...
<details class="details-block" markdown="1">
<summary markdown="1">
**Example.** Dual Norms of General Induced Norms
</summary>
