...
$$
B \leftarrow g_1 I + g_2 B + g_3 H_0 + g_4 H_0^2
$$
By using this algebraic flattening, we compute the DWH update using only one symmetric matrix squaring, $H_0^2$. The scale-invariant coefficients $g_1, g_2, g_3, g_4$ are pre-computed in FP64, eliminating all dynamic-range runtime evaluation. The orientation factor $K$ is simultaneously updated via $(u_0 I + v_0 H_0)$, where $u_0 = b/c$ and $v_0 = a - b/c$.
...
| :------- | :------------------- | :---------------------------------------------------------------------------- |
| **DWH**  | g1, g2, g3, g4       | 0.030883301527615, 0.968872554082809, 3.906861822017413, -3.937745123545028   |
|          | g0, u0, v0           | 0.000062499017684, 0.984313239818915, 251.007791810856                        |
| **PE 1** | u1, v1               | -1.595552602479211, 3.901806628246143                                         |
| **PE 2** | u2, v2               | 0.413372883404030, 0.780748444540736                                          |
