...
For stability: $\vert 1 - 100h\vert  < 1$, i.e. $h < 0.02$. Pick $h = 0.03$ and start at $(1, 1)$:
...
> 
> With $\lambda = 1$, the implied Lion constraint is $\vert x\vert  \le 1$. Constrained minimizer: $x^{\ast} = 1$.
